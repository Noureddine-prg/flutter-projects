...
class OU extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/OUlogo.jpg'),
        ElevatedButton(
...
class NYU extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/NYUlogo.jpg'),
        ElevatedButton(
...
class MIT extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/MITlogo.jpg'),
        ElevatedButton(
...
class HU extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/Harvardlogo.jpg'),
        ElevatedButton(
          child: Text('Cambridge. MA'),
          onPressed: () {
            Navigator.push(
...
class UCB extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/Berkeley.png'),
        ElevatedButton(
...
class UT extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/UTexas.png'),
        ElevatedButton(
...
class PU extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/Princeton.png'),
        ElevatedButton(
...
class CornellU extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/Cornell.png'),
        ElevatedButton(
...
class UP extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/Pennsylvania.png'),
        ElevatedButton(
          child: Text('Philadelphia, PA'),
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => Philadelphia()));
          },
        ),
...
class DU extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/Duke.jpg'),
        ElevatedButton(
...
class DC extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/Dartmouth.png'),
        ElevatedButton(
...
class UM extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/Minnesota.png'),
        ElevatedButton(
          child: Text('Minneapolis, MN'),
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => Minneapolis()));
          },
        ),
        Text(
...
class CarletonU extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.asset('lib/assets/Carleton.png'),
        ElevatedButton(
