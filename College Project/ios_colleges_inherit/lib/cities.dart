      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => Kansas()));
            },
          ),
          Padding(
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => Oklahoma()));
            },
          ),
          Padding(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ElevatedButton(
            child: Text('New York State'),
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => NewYorkS()));
            },
          ),
          Padding(
            padding: const EdgeInsets.all(1.0),
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => California()));
              },
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                    'Berkeley is a city in Northern California on the east side of San Francisco Bay. It’s home to the University of California, Berkeley, birthplace of the 1960s Free Speech Movement. The 1914 Sather Tower, known as '
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                    'Austin is the state capital of Texas, an inland city bordering the Hill Country region. Home to the University of Texas flagship campus, Austin is known for its eclectic live-music scene centered around country,'
          ...
          child: Column(
            ...
            children: [
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => NewJersey()));
                },
              ),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                    'Princeton is a town in New Jersey, known for the Ivy League Princeton University. The campus includes the Collegiate Gothic–style University Chapel and the broad collection of the Princeton University Art Museum.'
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                    'Ithaca is a city on Cayuga Lake, in New York’s Finger Lakes region. It’s home to Cornell University and its I.M. Pei–designed Herbert F. Johnson Museum of Art. The sprawling Cornell Botanic Gardens includes an arboretum'
          ...
          child: Column(
            ...
            children: [
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Pennsylvania()));
                },
               ),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                    'Philadelphia, Pennsylvania’s largest city, is notable for its rich history, on display at the Liberty Bell, Independence Hall (where the Declaration of Independence and Constitution were signed) and other American'
          ...
          child: Column(
            ...
            children: [
               ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => NewHampshire()));
                },
               ),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                    'Hanover is a town located along the Connecticut River in Grafton County, New Hampshire, United States. As of the 2010 census, its population was 11,260. The town is home to Dartmouth College, the US Army Corps of Engineers Cold Regions'
          ...
          child: Column(
            ...
            children: [
               ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Minnesota()));
                },
               ),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                    'Minneapolis is a major city in Minnesota that forms "Twin Cities" with the neighboring state capital of St. Paul. Bisected by the Mississippi River, it\'s known for its parks and lakes. Minneapolis is also home to many'
          ...
          child: Column(
            ...
            children: [
               ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Ontario()));
                },
               ),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                    'Ottawa is Canada’s capital, in the east of southern Ontario, near the city of Montréal and the U.S. border. Sitting on the Ottawa River, it has at its centre Parliament Hill, with grand Victorian architecture'
